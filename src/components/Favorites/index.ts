...
export { default as FavoriteItem } from "@/components/Favorites/components/FavoriteItem";
export { toggleFavoriteAction } from "@/components/Favorites/actions/toggleFavoriteAction";
