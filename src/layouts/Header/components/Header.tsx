...
export default function Header() {
  return (
    <header className=" border-b-[1px] border-b-[#BEBCBD]">
      <div className="relative mx-auto flex max-w-screen-xl items-center justify-between gap-6 px-4 py-2 md:justify-center">
        <Link href="/">
          <LogoIcon />
        </Link>
        <search className="relative w-full md:hidden">
        ...
        <div className="flex gap-4 md:hidden [&_button]:px-3">
